...
#SBATCH --mem=900GB                 # Memory pool for all cores (see also --mem-per-cpu)
...
# Run our code
echo "-------- PYTHON OUTPUT ----------"
srun -n 1 -N 1 -c 32 --mem=900GB --partition=a100 --time=1-14:00 --gres=gpu:4 accelerate launch diffusion_cfg.py
echo "---------------------------------"
